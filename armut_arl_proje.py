...
df=df.pivot_table(index='ID', columns='Service_Category', aggfunc='size', fill_value=0)
...
rules[(rules["support"]>0.01)& (rules['confidence']>0.10)&(rules["lift"]>4)]
...
arl_recommender(rules,product_id)
